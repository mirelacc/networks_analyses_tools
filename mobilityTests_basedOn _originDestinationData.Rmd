# Objective: test the methods described in the below mentioned paper in the context of the Netherlands.
...
- Inzichten uit de graviteitstheorie: bijvoorbeeld aannemen dat het verkeer tussen twee steden evenredig toeneemt met de grootte van de (beroeps)bevolking van de steden en omgekeerd evenredig is met het kwadraat van de afstand (of reistijd) tussen de steden.
- Inzichten uit de literatuur over verkeer en vervoer. 
- In ‘Verkeer en vervoer in hoofdlijnen’ staat bijvoorbeeld dat Schafer (1998) concludeert dat het reistijdbudget wereldwijd gemiddeld op 1,1 uur per persoon per dag ligt, ongeacht de economische, sociale en geografische situatie.
...
- Het model zou kunnen worden geijkt met behulp van verkeersmetingen, 
bijvoorbeeld met het aantal voertuigpassages op de snelwegen. 
